...
public class WindyhamhotelApplication {
	...
	@Bean
	CommandLineRunner runner2(ReviewRepository reviewRepository) {
		return args -> {
			reviewRepository.deleteAll();
			reviewRepository.save(new Review("Alice R", "Great hotel!!", "05-17-2021"));
//			reviewRepository.save(new Review("Lily X", "Great hotel!!", "05-17-2021"));
//			reviewRepository.save(new Review("Sherry R", "Great hotel!!", "05-17-2021"));
	...
	@Bean
	CommandLineRunner runner3(EmployeeRepository employeeRepository) {
		return args -> {
			Address address1 = new Address("IL", "Chicago", "4141 N State", "60601");
